...
2.	Edit tvault-config.answers, tvault-contego-answers.yml and tvault-horizon-plugin-answers.yml files to configure necessary parameters. Provide TLS certificate and private key in files triliovault.cert and triliovault.key respectively.
